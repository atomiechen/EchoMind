...
# ref: https://stackoverflow.com/a/68843198/11854304
class SinglePageApplication(StaticFiles):
    ...
    def lookup_path(self, path: str) -> Tuple[str, Optional[stat_result]]:
        ...
        Returns:
            [Tuple[str, os.stat_result | None]]: Always returns a full path and stat result.
        """
